...
<?php if( !empty( $result ) ){?>
	...
	<div class="col-2">
			<a class="fm-list-item rounded mb-4 bg-white" id="<?php _ec( $value->ids )?>" data-name="<?php _ec( $value->name )?>" href="javascript:void(0);" data-id="<?php _ec( $value->ids )?>" data-file="<?php _ec( $file_url )?>" >
				<img class="fm-list-overplay" src="<?php _ec( get_module_path( __DIR__, "Assets/img/overplay.png" ) )?>">
				<div class="fm-list-box">
