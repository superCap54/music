<?php 
if(!function_exists('get_pricing_page')){
    function get_pricing_page($params = []){
        echo view_cell('\Plugins\Payment\Controllers\Payment::pricing_page', $params); 
    }
}
