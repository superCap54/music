...
function Core(){
                ...
                $(this).select2({
                    ...
                    templateSelection: function(icon) {
                        ...
                        if( $(icon.element).data('icon-color') != undefined){
                            ...
                            return $('<span><i class="' + $(icon.element).data('icon') + ' select-option-icon" '+style+' ></i> <span class="select-option-text"> ' + icon.text + ' <span></span>');
                        }

                        if( $(icon.element).data('img') != undefined){
                            return $('<span><img src="' + $(icon.element).data('img') + '" class="w-17 select-option-img"> <span class="select-option-text"> ' + icon.text + ' <span></span>');
                        }

                        return $('<span><span class="select-option-text"> ' + icon.text + ' <span></span>');
                    },
    ...
    this.chart = function(options){
        Highcharts.chart(options.id, {
            ...
            xAxis: {
                allowDecimals: options.xallowDecimals?true:false,
            ...
            yAxis: {
                ...
                allowDecimals: options.yallowDecimals?true:false,
